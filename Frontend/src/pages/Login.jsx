...
function Login() {
  ...
  return (
    <div className='w-full h-screen flex flex-col justify-start gap-[10px]'>
      ...
      <form className='flex flex-col items-center justify-center w-[90%] max-w-[400px] mx-auto h-[80%] gap-6 md:shadow-xl' onSubmit={handleLogin}>
        <h1 className='text-3xl font-bold mt-[-20px]'>Log In</h1>
        ...
        <button type="submit" className='w-[80%] p-3 bg-blue-600 text-white font-semibold rounded-md hover:bg-blue-700 transition duration-300' disabled={loading}>{loading ? 'Loading...' : 'Log In'}</button>     

        <p>want to create an new account? <Link to="/signup" className="text-blue-600 hover:underline">Sign Up</Link></p>
      </form>
    </div>
  )
}
